...
public class CalendarEvent {
    ...
    public CalendarEvent(String title, String description, String eventLocation,
                         long start, long end, int advanceTime, String rRule, int hasAlarm) {
        this.title = title;
    ...
    public CalendarEvent(long id, String title, String description, String eventLocation,
                         long start, long end, int advanceTime, String rRule, int hasAlarm, String eventStatus) {
        this.title = title;
        this.description = description;
        this.eventLocation = eventLocation;
        this.start = start;
